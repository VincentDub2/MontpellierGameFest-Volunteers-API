...
describe('Creneau API Endpoints', () => {
    ...
    it('should create a new creneau', async () => {
        ...
        const newCreneau = { timeStart: new Date('2022-01-01T10:00:00'), timeEnd: new Date('2022-01-01T12:00:00'), idFestival: fest.idFestival };
    ...
    it('should create multiple creneaux', async () => {
        ...
        if (!fest) throw new Error('Festival not found');
        const creneauxData = [
            { timeStart: new Date('2022-01-02T10:00:00'), timeEnd: new Date('2022-01-02T12:00:00'),idFestival : fest.idFestival},
            { timeStart: new Date('2022-01-02T14:00:00'), timeEnd: new Date('2022-01-02T16:00:00'),idFestival: fest.idFestival},];
    ...
    it('should return a single creneau', async () => {
        ...
        const creneau = await prisma.creneau.create({ // Assurez-vous d'avoir la table 'creneau'
            data: { timeStart: new Date('2022-01-03T10:00:00'), timeEnd: new Date('2022-01-03T12:00:00'), idFestival: fest.idFestival }
        });
    ...
    it('should update a creneau', async () => {
        ...
        if (!fest) throw new Error('Festival not found');
        const creneau = await prisma.creneau.create({ // Assurez-vous d'avoir la table 'creneau'
            data: { timeStart: new Date('2022-01-04T10:00:00'), timeEnd: new Date('2022-01-04T12:00:00').toISOString(), idFestival: fest.idFestival }
        });
    ...
    it('should delete a creneau', async () => {
        ...
        const creneau = await prisma.creneau.create({
            data: { timeStart: new Date('2022-01-05T10:00:00'), timeEnd: new Date('2022-01-05T12:00:00'), idFestival: fest.idFestival}
        });
